...
import common.*;
import interfaces.ScoreCounter;
import ritualItems.RitualItem;
...
public class Entity implements Comparable <Entity> {
    ...
    public Entity(String name, Devotions devotion, int age, int height, int weight, Genders gender) {
        this.name = name;
        this.devotion = devotion;
        this.race = Races.Hattifattner;
        this.age = age;
        this.height = height;
        this.weight = weight;
        this.gender = gender;
